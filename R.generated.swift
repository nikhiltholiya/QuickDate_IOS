...
struct _R {
  ...
  struct string {
    ...
    /// This `_R.string.localizable` struct is generated, and contains static references to 356 localization keys.
    struct localizable {
      let source: RswiftResources.StringResource.Source

      /// en translation:  permanently from QuickDate Account.
      ///
      /// Key:  permanently from QuickDate Account.
      ///
      /// Locales: en, tr
      var permanentlyFromQuickDateAccount: RswiftResources.StringResource { .init(key: " permanently from QuickDate Account.", tableName: "Localizable", source: source, developmentValue: " permanently from QuickDate Account.", comment: nil) }
      ...
      /// en translation: Buy Credits
      ///
      /// Key: Buy Credit
      ///
      /// Locales: en, tr
      var buyCredit: RswiftResources.StringResource { .init(key: "Buy Credit", tableName: "Localizable", source: source, developmentValue: "Buy Credits", comment: nil) }
      ...
      /// en translation: Confirm request when someone request to be a friend with you?
      ///
      /// Key: Confirm request when someone request to be a friend with you?
      ///
      /// Locales: en, tr
      var confirmRequestWhenSomeoneRequestToBeAFriendWithYou: RswiftResources.StringResource { .init(key: "Confirm request when someone request to be a friend with you?", tableName: "Localizable", source: source, developmentValue: "Confirm request when someone request to be a friend with you?", comment: nil) }
      ...
      /// en translation: Do you want to log out from this device?
      ///
      /// Key: Do you want to log out from this device?
      ///
      /// Locales: en, tr
      var doYouWantToLogOutFromThisDevice: RswiftResources.StringResource { .init(key: "Do you want to log out from this device?", tableName: "Localizable", source: source, developmentValue: "Do you want to log out from this device?", comment: nil) }
      ...
      /// en translation: The files will be deleted. Are you sure?
      ///
      /// Key: The files will be deleted. Are you sure?
      ///
      /// Locales: en, tr
      var theFilesWillBeDeletedAreYouSure: RswiftResources.StringResource { .init(key: "The files will be deleted. Are you sure?", tableName: "Localizable", source: source, developmentValue: "The files will be deleted. Are you sure?", comment: nil) }
      ...
      /// en translation: Yes, I want to delete 
      ///
      /// Key: Yes, I want to delete 
      ///
      /// Locales: en, tr
      var yesIWantToDelete: RswiftResources.StringResource { .init(key: "Yes, I want to delete ", tableName: "Localizable", source: source, developmentValue: "Yes, I want to delete ", comment: nil) }
  ...
  /// This `_R.image` struct is generated, and contains static references to 412 images.
  struct image {
    let bundle: Foundation.Bundle
    ...
    /// Image `CodeVerification`.
    var codeVerification: RswiftResources.ImageResource { .init(name: "CodeVerification", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `bottom_effect`.
    var bottom_effect: RswiftResources.ImageResource { .init(name: "bottom_effect", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `heart_1`.
    var heart_1: RswiftResources.ImageResource { .init(name: "heart_1", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `ic_drink`.
    var ic_drink: RswiftResources.ImageResource { .init(name: "ic_drink", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `ic_drink_1`.
    var ic_drink_1: RswiftResources.ImageResource { .init(name: "ic_drink_1", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `ic_education`.
    var ic_education: RswiftResources.ImageResource { .init(name: "ic_education", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `ic_speed`.
    var ic_speed: RswiftResources.ImageResource { .init(name: "ic_speed", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `icn_aamarPay`.
    var icn_aamarPay: RswiftResources.ImageResource { .init(name: "icn_aamarPay", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_about`.
    var icn_about: RswiftResources.ImageResource { .init(name: "icn_about", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_authorizenet`.
    var icn_authorizenet: RswiftResources.ImageResource { .init(name: "icn_authorizenet", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_bag`.
    var icn_bag: RswiftResources.ImageResource { .init(name: "icn_bag", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `icn_body`.
    var icn_body: RswiftResources.ImageResource { .init(name: "icn_body", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_book`.
    var icn_book: RswiftResources.ImageResource { .init(name: "icn_book", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_call`.
    var icn_call: RswiftResources.ImageResource { .init(name: "icn_call", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_car`.
    var icn_car: RswiftResources.ImageResource { .init(name: "icn_car", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_cashfree`.
    var icn_cashfree: RswiftResources.ImageResource { .init(name: "icn_cashfree", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_cat`.
    var icn_cat: RswiftResources.ImageResource { .init(name: "icn_cat", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_character`.
    var icn_character: RswiftResources.ImageResource { .init(name: "icn_character", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_chat`.
    var icn_chat: RswiftResources.ImageResource { .init(name: "icn_chat", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_chat_image`.
    var icn_chat_image: RswiftResources.ImageResource { .init(name: "icn_chat_image", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_children`.
    var icn_children: RswiftResources.ImageResource { .init(name: "icn_children", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_city`.
    var icn_city: RswiftResources.ImageResource { .init(name: "icn_city", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_coinbase`.
    var icn_coinbase: RswiftResources.ImageResource { .init(name: "icn_coinbase", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_color`.
    var icn_color: RswiftResources.ImageResource { .init(name: "icn_color", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_copy`.
    var icn_copy: RswiftResources.ImageResource { .init(name: "icn_copy", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_dish`.
    var icn_dish: RswiftResources.ImageResource { .init(name: "icn_dish", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_dislike`.
    var icn_dislike: RswiftResources.ImageResource { .init(name: "icn_dislike", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_drink`.
    var icn_drink: RswiftResources.ImageResource { .init(name: "icn_drink", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_education`.
    var icn_education: RswiftResources.ImageResource { .init(name: "icn_education", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_ethnicity`.
    var icn_ethnicity: RswiftResources.ImageResource { .init(name: "icn_ethnicity", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_flutterwave`.
    var icn_flutterwave: RswiftResources.ImageResource { .init(name: "icn_flutterwave", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_friends`.
    var icn_friends: RswiftResources.ImageResource { .init(name: "icn_friends", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_hair_color`.
    var icn_hair_color: RswiftResources.ImageResource { .init(name: "icn_hair_color", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_hobby`.
    var icn_hobby: RswiftResources.ImageResource { .init(name: "icn_hobby", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_language`.
    var icn_language: RswiftResources.ImageResource { .init(name: "icn_language", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_live_with`.
    var icn_live_with: RswiftResources.ImageResource { .init(name: "icn_live_with", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_message`.
    var icn_message: RswiftResources.ImageResource { .init(name: "icn_message", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_movie`.
    var icn_movie: RswiftResources.ImageResource { .init(name: "icn_movie", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_musical_note`.
    var icn_musical_note: RswiftResources.ImageResource { .init(name: "icn_musical_note", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_ngenius`.
    var icn_ngenius: RswiftResources.ImageResource { .init(name: "icn_ngenius", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_paystack`.
    var icn_paystack: RswiftResources.ImageResource { .init(name: "icn_paystack", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_religion`.
    var icn_religion: RswiftResources.ImageResource { .init(name: "icn_religion", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_select`.
    var icn_select: RswiftResources.ImageResource { .init(name: "icn_select", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_selected_cell`.
    var icn_selected_cell: RswiftResources.ImageResource { .init(name: "icn_selected_cell", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_share_fill`.
    var icn_share_fill: RswiftResources.ImageResource { .init(name: "icn_share_fill", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_smile`.
    var icn_smile: RswiftResources.ImageResource { .init(name: "icn_smile", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_smoke`.
    var icn_smoke: RswiftResources.ImageResource { .init(name: "icn_smoke", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_song`.
    var icn_song: RswiftResources.ImageResource { .init(name: "icn_song", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_sport`.
    var icn_sport: RswiftResources.ImageResource { .init(name: "icn_sport", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_team`.
    var icn_team: RswiftResources.ImageResource { .init(name: "icn_team", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_transations`.
    var icn_transations: RswiftResources.ImageResource { .init(name: "icn_transations", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_travel`.
    var icn_travel: RswiftResources.ImageResource { .init(name: "icn_travel", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_tv`.
    var icn_tv: RswiftResources.ImageResource { .init(name: "icn_tv", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_unselect`.
    var icn_unselect: RswiftResources.ImageResource { .init(name: "icn_unselect", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_user`.
    var icn_user: RswiftResources.ImageResource { .init(name: "icn_user", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icn_user_no_profile`.
    var icn_user_no_profile: RswiftResources.ImageResource { .init(name: "icn_user_no_profile", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `icon_no_user_vector`.
    var icon_no_user_vector: RswiftResources.ImageResource { .init(name: "icon_no_user_vector", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icon_phone_number_verified`.
    var icon_phone_number_verified: RswiftResources.ImageResource { .init(name: "icon_phone_number_verified", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }

    /// Image `icon_smile_live`.
    var icon_smile_live: RswiftResources.ImageResource { .init(name: "icon_smile_live", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `musical-note`.
    var musicalNote: RswiftResources.ImageResource { .init(name: "musical-note", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    var starHalfFilled: RswiftResources.ImageResource { .init(name: "star-half-filled", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `top_effect`.
    var top_effect: RswiftResources.ImageResource { .init(name: "top_effect", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
  ...
  struct file {
    ...
    /// Resource file `ProExplodeAnim.json`.
    var proExplodeAnimJson: RswiftResources.FileResource { .init(name: "ProExplodeAnim", pathExtension: "json", bundle: bundle, locale: LocaleReference.none) }
  ...
  /// This `_R.nib` struct is generated, and contains static references to 68 nibs.
  struct nib {
    let bundle: Foundation.Bundle
    ...
    /// Nib `GetPremiumStickerCell`.
    var getPremiumStickerCell: RswiftResources.NibReferenceReuseIdentifier<GetPremiumStickerCell, GetPremiumStickerCell> { .init(name: "GetPremiumStickerCell", bundle: bundle, identifier: "GetPremiumStickerCell") }
    ...
    /// Nib `ListVisitCollectionItem`.
    var listVisitCollectionItem: RswiftResources.NibReferenceReuseIdentifier<ListVisitCollectionItem, ListVisitCollectionItem> { .init(name: "ListVisitCollectionItem", bundle: bundle, identifier: "ListVisitCollectionItem") }

    /// Nib `LiverUserCollectionViewCell`.
    var liverUserCollectionViewCell: RswiftResources.NibReferenceReuseIdentifier<LiverUserCollectionViewCell, LiverUserCollectionViewCell> { .init(name: "LiverUserCollectionViewCell", bundle: bundle, identifier: "LiverUserCollectionViewCell") }
    ...
    /// Nib `PreviewView`.
    var previewView: RswiftResources.NibReference<PreviewView> { .init(name: "PreviewView", bundle: bundle) }
    ...
    /// Nib `TagViewCollectionViewCell`.
    var tagViewCollectionViewCell: RswiftResources.NibReferenceReuseIdentifier<TagViewCollectionViewCell, TagViewCollectionViewCell> { .init(name: "TagViewCollectionViewCell", bundle: bundle, identifier: "TagViewCollectionViewCell") }
    ...
    /// Nib `UserTagViewCell`.
    var userTagViewCell: RswiftResources.NibReferenceReuseIdentifier<UserTagViewCell, UserTagViewCell> { .init(name: "UserTagViewCell", bundle: bundle, identifier: "UserTagViewCell") }
    ...
    func validate() throws {
      ...
      if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in nib 'BlockUserTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in nib 'BlogsTableCell', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "ic_lucide_gift", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_lucide_gift' is used in nib 'BuyCreditSectionOneCollectionItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in nib 'BuyCreditSectionOneCollectionItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'BuyCreditSectionOneCollectionItem', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in nib 'BuyCreditSectionTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "secondaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryTextColor' is used in nib 'BuyCreditSectionThreeTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in nib 'BuyCreditSectionTwoCollectionItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'BuyCreditSectionTwoCollectionItem', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "ic_empty_user", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_empty_user' is used in nib 'ContactCell', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in nib 'ContactCell', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "Background", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'Background' is used in nib 'GetPremiumStickerCell', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'GetPremiumStickerCell', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in nib 'HotOrNotCollectionItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'HotOrNotCollectionItem', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "loginBgrImage", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'loginBgrImage' is used in nib 'LiverUserCollectionViewCell', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in nib 'LiverUserCollectionViewCell', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "videoBackground", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'videoBackground' is used in nib 'PreviewView', but couldn't be loaded.") }
      if UIKit.UIColor(named: "videoPlaceholder", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'videoPlaceholder' is used in nib 'PreviewView', but couldn't be loaded.") }
      if UIKit.UIImage(named: "heart", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'heart' is used in nib 'ProfileGideCell', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'ProfileGideCell', but couldn't be loaded.") }
      if UIKit.UIImage(named: "eye", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'eye' is used in nib 'ProfileSectionOneTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "ic_heart", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_heart' is used in nib 'ProfileSectionOneTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in nib 'ProfileSectionOneTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in nib 'ProfileSectionOneTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'ProfileSectionOneTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "secondaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryTextColor' is used in nib 'ProfileSectionOneTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "ic_rightArrow", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_rightArrow' is used in nib 'SettingsSectionTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in nib 'SettingsSectionThreeTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "menu_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'menu_ic' is used in nib 'ShowUserDetailsTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in nib 'ShowUserDetailsTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'ShowUserDetailsTableItem', but couldn't be loaded.") }
      if UIKit.UIColor(named: "secondaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryTextColor' is used in nib 'ShowUserDetailsTableItem', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "no_profile_image", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'no_profile_image' is used in nib 'TabView', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'UserActivityCell', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'UserLocationCell', but couldn't be loaded.") }
      if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in nib 'UserTagViewCell', but couldn't be loaded.") }
  ...
  /// This `_R.reuseIdentifier` struct is generated, and contains static references to 56 reuse identifiers.
  struct reuseIdentifier {
    ...
    /// Reuse identifier `GetPremiumStickerCell`.
    let getPremiumStickerCell: RswiftResources.ReuseIdentifier<GetPremiumStickerCell> = .init(identifier: "GetPremiumStickerCell")
    ...
    /// Reuse identifier `ListVisitCollectionItem`.
    let listVisitCollectionItem: RswiftResources.ReuseIdentifier<ListVisitCollectionItem> = .init(identifier: "ListVisitCollectionItem")

    /// Reuse identifier `LiverUserCollectionViewCell`.
    let liverUserCollectionViewCell: RswiftResources.ReuseIdentifier<LiverUserCollectionViewCell> = .init(identifier: "LiverUserCollectionViewCell")
    ...
    /// Reuse identifier `TagViewCollectionViewCell`.
    let tagViewCollectionViewCell: RswiftResources.ReuseIdentifier<TagViewCollectionViewCell> = .init(identifier: "TagViewCollectionViewCell")
    ...
    /// Reuse identifier `UserTagViewCell`.
    let userTagViewCell: RswiftResources.ReuseIdentifier<UserTagViewCell> = .init(identifier: "UserTagViewCell")
  }
  ...
  struct storyboard {
    ...
    struct authentication: RswiftResources.StoryboardReference, RswiftResources.InitialControllerContainer {
      ...
      func validate() throws {
        ...
        if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in storyboard 'Authentication', but couldn't be loaded.") }
    ...
    struct blogs: RswiftResources.StoryboardReference, RswiftResources.InitialControllerContainer {
      ...
      func validate() throws {
        if UIKit.UIImage(named: "bottom right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bottom right gradient' is used in storyboard 'Blogs', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "icn_copy", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_copy' is used in storyboard 'Blogs', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_share_fill", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_share_fill' is used in storyboard 'Blogs', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "top right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'top right gradient' is used in storyboard 'Blogs', but couldn't be loaded.") }
    ...
    struct chat: RswiftResources.StoryboardReference {
      ...
      var imagePreviewVC: RswiftResources.StoryboardViewControllerIdentifier<ImagePreviewVC> { .init(identifier: "ImagePreviewVC", storyboard: name, bundle: bundle) }
      ...
      func validate() throws {
        if UIKit.UIImage(named: "gray_back_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'gray_back_ic' is used in storyboard 'Chat', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "ic_close_white", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_close_white' is used in storyboard 'Chat', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "icn_copy", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_copy' is used in storyboard 'Chat', but couldn't be loaded.") }
        ...
        if imagePreviewVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'imagePreviewVC' could not be loaded from storyboard 'Chat' as 'ImagePreviewVC'.") }
    ...
    struct credit: RswiftResources.StoryboardReference {
      ...
      func validate() throws {
        ...
        if UIKit.UIImage(named: "bottom right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bottom right gradient' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "card_unknown_icon.png", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'card_unknown_icon.png' is used in storyboard 'Credit', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "icn_aamarPay", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_aamarPay' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_authorizenet", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_authorizenet' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_cashfree", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_cashfree' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_coinbase", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_coinbase' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_flutterwave", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_flutterwave' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_ngenius", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_ngenius' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_paystack", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_paystack' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIImage(named: "top right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'top right gradient' is used in storyboard 'Credit', but couldn't be loaded.") }
        if UIKit.UIColor(named: "Label_Colors_Tertiary", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'Label_Colors_Tertiary' is used in storyboard 'Credit', but couldn't be loaded.") }
        ...
        if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in storyboard 'Credit', but couldn't be loaded.") }
        ...
        if paymentCardVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'paymentCardVC' could not be loaded from storyboard 'Credit' as 'PaymentCardVC'.") }
    ...
    struct dashboard: RswiftResources.StoryboardReference {
      ...
      func validate() throws {
        ...
        if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in storyboard 'Dashboard', but couldn't be loaded.") }
        if UIKit.UIColor(named: "secondaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryBackgroundColor' is used in storyboard 'Dashboard', but couldn't be loaded.") }
    ...
    struct live: RswiftResources.StoryboardReference {
      ...
      var goLiveStreamVC: RswiftResources.StoryboardViewControllerIdentifier<GoLiveStreamVC> { .init(identifier: "GoLiveStreamVC", storyboard: name, bundle: bundle) }
      ...
      var liveUserVC: RswiftResources.StoryboardViewControllerIdentifier<LiveUserVC> { .init(identifier: "LiveUserVC", storyboard: name, bundle: bundle) }

      func validate() throws {
        if UIKit.UIImage(named: "Background", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'Background' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIImage(named: "bottom right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bottom right gradient' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIImage(named: "eye", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'eye' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIImage(named: "gray_back_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'gray_back_ic' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIImage(named: "ic_empty_user", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_empty_user' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icon_no_user_vector", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icon_no_user_vector' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icon_smile_live", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icon_smile_live' is used in storyboard 'Live', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "send_msg_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'send_msg_ic' is used in storyboard 'Live', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "top right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'top right gradient' is used in storyboard 'Live', but couldn't be loaded.") }
        ...
        if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in storyboard 'Live', but couldn't be loaded.") }
        if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in storyboard 'Live', but couldn't be loaded.") }
        ...
        if goLiveStreamVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'goLiveStreamVC' could not be loaded from storyboard 'Live' as 'GoLiveStreamVC'.") }
        ...
        if liveUserVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'liveUserVC' could not be loaded from storyboard 'Live' as 'LiveUserVC'.") }
      }
    }
    ...
    struct main: RswiftResources.StoryboardReference {
      ...
      func validate() throws {
        ...
        if UIKit.UIImage(named: "bottom right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bottom right gradient' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "diamond_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'diamond_ic' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIImage(named: "gray_back_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'gray_back_ic' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "ic_speed", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_speed' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIImage(named: "ic_star-1", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'ic_star-1' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_chat", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_chat' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_dislike", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_dislike' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIImage(named: "menu_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'menu_ic' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "top right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'top right gradient' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in storyboard 'Main', but couldn't be loaded.") }
        if UIKit.UIColor(named: "secondaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryBackgroundColor' is used in storyboard 'Main', but couldn't be loaded.") }
    ...
    struct popUps: RswiftResources.StoryboardReference {
      ...
      var chatPopupVC: RswiftResources.StoryboardViewControllerIdentifier<ChatPopupVC> { .init(identifier: "ChatPopupVC", storyboard: name, bundle: bundle) }
      ...
      var imagePickerPopupVC: RswiftResources.StoryboardViewControllerIdentifier<ImagePickerPopupVC> { .init(identifier: "ImagePickerPopupVC", storyboard: name, bundle: bundle) }
      ...
      var noProfileVC: RswiftResources.StoryboardViewControllerIdentifier<NoProfileVC> { .init(identifier: "NoProfileVC", storyboard: name, bundle: bundle) }
      ...
      var twoFactorPopupVC: RswiftResources.StoryboardViewControllerIdentifier<TwoFactorPopupVC> { .init(identifier: "TwoFactorPopupVC", storyboard: name, bundle: bundle) }
      var userMoreOptionPopupVC: RswiftResources.StoryboardViewControllerIdentifier<UserMoreOptionPopupVC> { .init(identifier: "UserMoreOptionPopupVC", storyboard: name, bundle: bundle) }
      ...
      var withdrawalMethodPopupVC: RswiftResources.StoryboardViewControllerIdentifier<WithdrawalMethodPopupVC> { .init(identifier: "WithdrawalMethodPopupVC", storyboard: name, bundle: bundle) }

      func validate() throws {
        if UIKit.UIImage(named: "Background", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'Background' is used in storyboard 'PopUps', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "icn_user_no_profile", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_user_no_profile' is used in storyboard 'PopUps', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icon_camera", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icon_camera' is used in storyboard 'PopUps', but couldn't be loaded.") }
        ...
        if UIKit.UIColor(named: "primaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryBackgroundColor' is used in storyboard 'PopUps', but couldn't be loaded.") }
        if UIKit.UIColor(named: "primaryEndColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryEndColor' is used in storyboard 'PopUps', but couldn't be loaded.") }
        if UIKit.UIColor(named: "primaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'primaryTextColor' is used in storyboard 'PopUps', but couldn't be loaded.") }
        if UIKit.UIColor(named: "secondaryTextColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryTextColor' is used in storyboard 'PopUps', but couldn't be loaded.") }
        ...
        if chatPopupVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'chatPopupVC' could not be loaded from storyboard 'PopUps' as 'ChatPopupVC'.") }
        ...
        if imagePickerPopupVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'imagePickerPopupVC' could not be loaded from storyboard 'PopUps' as 'ImagePickerPopupVC'.") }
        ...
        if noProfileVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'noProfileVC' could not be loaded from storyboard 'PopUps' as 'NoProfileVC'.") }
        ...
        if twoFactorPopupVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'twoFactorPopupVC' could not be loaded from storyboard 'PopUps' as 'TwoFactorPopupVC'.") }
        if userMoreOptionPopupVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'userMoreOptionPopupVC' could not be loaded from storyboard 'PopUps' as 'UserMoreOptionPopupVC'.") }
        ...
        if withdrawalMethodPopupVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'withdrawalMethodPopupVC' could not be loaded from storyboard 'PopUps' as 'WithdrawalMethodPopupVC'.") }
      }
    }
    ...
    struct settings: RswiftResources.StoryboardReference {
      ...
      var codeVerificationVC: RswiftResources.StoryboardViewControllerIdentifier<CodeVerificationVC> { .init(identifier: "CodeVerificationVC", storyboard: name, bundle: bundle) }
      ...
      var editProfileInfoVC: RswiftResources.StoryboardViewControllerIdentifier<EditProfileInfoVC> { .init(identifier: "EditProfileInfoVC", storyboard: name, bundle: bundle) }
      ...
      var phoneNumberVerificationVC: RswiftResources.StoryboardViewControllerIdentifier<PhoneNumberVerificationVC> { .init(identifier: "PhoneNumberVerificationVC", storyboard: name, bundle: bundle) }
      var profilePreviewVC: RswiftResources.StoryboardViewControllerIdentifier<ProfilePreviewVC> { .init(identifier: "ProfilePreviewVC", storyboard: name, bundle: bundle) }
      var profileVisitVC: RswiftResources.StoryboardViewControllerIdentifier<ProfileVisitVC> { .init(identifier: "ProfileVisitVC", storyboard: name, bundle: bundle) }
      ...
      var userLikesVC: RswiftResources.StoryboardViewControllerIdentifier<UserLikesVC> { .init(identifier: "UserLikesVC", storyboard: name, bundle: bundle) }
      ...
      func validate() throws {
        if UIKit.UIImage(named: "CodeVerification", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'CodeVerification' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "bottom right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bottom right gradient' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "heart", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'heart' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "icn_about", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_about' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_bag", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_bag' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "icn_body", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_body' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_book", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_book' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_call", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_call' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_car", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_car' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_cat", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_cat' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_character", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_character' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_children", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_children' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_city", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_city' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_color", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_color' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_dish", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_dish' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_drink", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_drink' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_education", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_education' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_ethnicity", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_ethnicity' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_friends", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_friends' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_hair_color", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_hair_color' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_hobby", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_hobby' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_language", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_language' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_live_with", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_live_with' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_movie", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_movie' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_musical_note", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_musical_note' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_religion", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_religion' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_smoke", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_smoke' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_song", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_song' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_sport", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_sport' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_team", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_team' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_transations", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_transations' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_travel", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_travel' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_tv", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_tv' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_unselect", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_unselect' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icn_user", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icn_user' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icon_no_user_vector", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icon_no_user_vector' is used in storyboard 'Settings', but couldn't be loaded.") }
        if UIKit.UIImage(named: "icon_phone_number_verified", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'icon_phone_number_verified' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "refresh", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'refresh' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "star-half-filled", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'star-half-filled' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "top right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'top right gradient' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if aboutVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'aboutVC' could not be loaded from storyboard 'Settings' as 'AboutVC'.") }
        ...
        if codeVerificationVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'codeVerificationVC' could not be loaded from storyboard 'Settings' as 'CodeVerificationVC'.") }
        ...
        if editProfileInfoVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'editProfileInfoVC' could not be loaded from storyboard 'Settings' as 'EditProfileInfoVC'.") }
        ...
        if phoneNumberVerificationVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'phoneNumberVerificationVC' could not be loaded from storyboard 'Settings' as 'PhoneNumberVerificationVC'.") }
        if profilePreviewVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'profilePreviewVC' could not be loaded from storyboard 'Settings' as 'ProfilePreviewVC'.") }
        if profileVisitVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'profileVisitVC' could not be loaded from storyboard 'Settings' as 'ProfileVisitVC'.") }
        ...
        if userLikesVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'userLikesVC' could not be loaded from storyboard 'Settings' as 'UserLikesVC'.") }
    ...
    struct trending: RswiftResources.StoryboardReference {
      ...
      func validate() throws {
        ...
        if UIKit.UIImage(named: "bottom right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bottom right gradient' is used in storyboard 'Trending', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "gray_back_ic", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'gray_back_ic' is used in storyboard 'Trending', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "top right gradient", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'top right gradient' is used in storyboard 'Trending', but couldn't be loaded.") }
        ...
        if UIKit.UIColor(named: "secondaryBackgroundColor", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'secondaryBackgroundColor' is used in storyboard 'Trending', but couldn't be loaded.") }
