...
@objc
class AgoraNetworkManager: NSObject {
    ...
    @objc
    static let shared = AgoraNetworkManager()
    ...
    func generateToken(channelName: String, uid: UInt = 0, success: @escaping (String?) -> Void) {
        ...
        AgoraNetworkManager.shared.postRequest(urlString: "https://toolbox.bj2.agoralab.co/v1/token/generate", params: params, success: { response in
