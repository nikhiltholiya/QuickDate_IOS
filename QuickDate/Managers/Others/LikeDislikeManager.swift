...
class LikeDislikeMananger{
    ...
    func deleteDislike(AccessToken: String, id:Int, completionBlock: @escaping (_ Success: DisLikeDeleteModel.DisLikeDeleteSuccessModel?, _ sessionError: DisLikeDeleteModel.DisLikeDeleteErrorModel?, Error?) ->()) {
        let params = [
            API.PARAMS.access_token: AccessToken,
