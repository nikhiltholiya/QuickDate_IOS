...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var cornerRadius: CGFloat = 20.0 {
        didSet {
            tagViews.forEach {
    ...
    @IBInspectable open dynamic var paddingY: CGFloat = 7 {
        didSet {
    ...
    @IBInspectable open dynamic var marginY: CGFloat = 7 {
        didSet {
            rearrangeViews()
        }
    }
    ...
    @IBInspectable open dynamic var shadowRadiuss: CGFloat = 0 {
        didSet {
            rearrangeViews()
        }
    }
    ...
    @objc open dynamic var textFont: UIFont = Typography.regularText(size: 16.0).font {
        didSet {
            defer { rearrangeViews() }
            tagViews.forEach {
                $0.textFont = textFont
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            tagBackgroundView.layer.shadowRadius = shadowRadiuss
...
//        tagView.borderColor = borderColor
        ...
        tagView.tagBackgroundColor = color.bg
        tagView.textColor = color.fg
