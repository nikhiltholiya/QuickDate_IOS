...
open class TagView: UIButton {
    ...
    @IBInspectable open var paddingY: CGFloat = 7 {
        didSet {
            titleEdgeInsets.top = paddingY
            titleEdgeInsets.bottom = paddingY
        }
    }
    @IBInspectable open var paddingX: CGFloat = 7 {
        didSet {
    ...
    @IBInspectable open var textFont: UIFont = Typography.regularText(size: 16.0).font {
        didSet {
    ...
    override open var intrinsicContentSize: CGSize {
        ...
        size.height = 40.0//textFont.pointSize + paddingY * 2
